            ...
            <form class="mt-6 space-y-5" action="/register" method="POST">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" id="name" name="name" class="input-field !pl-11" placeholder="Contoh: Siti Aminah" value="{{ old('name') }}" required>
                    </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="tel" id="reg_whatsapp" name="whatsapp" class="input-field !pl-11" placeholder="Contoh: 08123456789" value="{{ old('whatsapp') }}" required>
                    </div>
                    @error('whatsapp')<p class="mt-1 text-xs text-red-500">{{ $message }}</p>@enderror
                </div>

                <div>
                    <label for="reg_email" class="block text-sm font-semibold text-neutral-700 mb-1.5">Email</label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                        ...
                        <input type="email" id="reg_email" name="email" class="input-field !pl-11" placeholder="Contoh: nama@email.com" value="{{ old('email') }}" required>
                    </div>
                ...
                <div>
                    ...
                    <textarea id="address" name="address" rows="2" class="input-field resize-none" placeholder="Jl. Raya Parungpanjang No. ..." required>{{ old('address') }}</textarea>
                ...
                <div x-data="{ show: false }">
                    ...
                    <div class="relative">
                        ...
                        <input :type="show ? 'text' : 'password'" id="reg_password" name="password" class="input-field !pl-11 !pr-11" placeholder="Minimal 8 karakter" required>
                ...
                <label class="flex items-start gap-2 cursor-pointer">
                    <input type="checkbox" name="terms" class="w-4 h-4 mt-0.5 rounded border-neutral-300 text-primary-600 focus:ring-primary-500" required>
