...
<section class="relative min-h-[80vh] flex items-center justify-center py-16 bg-gradient-to-br from-primary-50/50 via-white to-primary-50/30 overflow-hidden">
    ...
    <div class="relative z-10 w-full max-w-md mx-auto px-4">
            ...
            <form class="mt-6 space-y-5" action="/login" method="POST">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="tel" id="whatsapp" name="whatsapp" class="input-field !pl-11" placeholder="Contoh: 08123456789" value="{{ old('whatsapp') }}" required>
                    </div>
                ...
                <div x-data="{ show: false }">
                    <div class="flex items-center justify-between mb-1.5">
                        ...
                        <a href="/lupa-password" class="text-xs font-semibold text-primary-600 hover:text-primary-700">Lupa sandi?</a>
                    </div>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                        ...
                        <input :type="show ? 'text' : 'password'" id="password" name="password" class="input-field !pl-11 !pr-11" placeholder="••••••••" required>
                ...
                <label class="flex items-center gap-2 cursor-pointer">
                    <input type="checkbox" name="remember" class="w-4 h-4 rounded border-neutral-300 text-primary-600 focus:ring-primary-500" {{ old('remember') ? 'checked' : '' }}>
        ...
        <div class="mt-6 border-2 border-dashed border-neutral-300 rounded-2xl p-5 bg-white/60 backdrop-blur-sm">
            <div class="mb-4 rounded-xl border border-primary-100 bg-primary-50 p-3">
