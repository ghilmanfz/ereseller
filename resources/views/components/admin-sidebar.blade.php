...
<aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" class="fixed inset-y-0 left-0 z-50 w-60 bg-white border-r border-neutral-100 transition-transform duration-300 lg:translate-x-0 flex flex-col">
    ...
    <nav class="flex-1 py-4 px-3 space-y-1">
        ...
        $adminNav = [
            ...
            ['label' => 'Produk dan Pesanan', 'url' => '/admin/produk-pesanan', 'icon' => 'M20.25 7.5l-.625 10.632a2.25 2.25 0 01-2.247 2.118H6.622a2.25 2.25 0 01-2.247-2.118L3.75 7.5M10 11.25h4M3.375 7.5h17.25c.621 0 1.125-.504 1.125-1.125v-1.5c0-.621-.504-1.125-1.125-1.125H3.375c-.621 0-1.125.504-1.125 1.125v1.5c0 .621.504 1.125 1.125 1.125z', 'active' => 'admin/produk-pesanan'],
        ];
        @endphp

        @foreach($adminNav as $nav)
        <a href="{{ $nav['url'] }}" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all {{ request()->is($nav['active']) ? 'bg-primary-50 text-primary-700' : 'text-neutral-600 hover:bg-neutral-50 hover:text-neutral-800' }}">
    ...
    <div class="p-3 border-t border-neutral-100 space-y-1">
        <a href="#" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-neutral-600 hover:bg-neutral-50">
        ...
        <a href="/" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-primary-600 hover:bg-primary-50">
